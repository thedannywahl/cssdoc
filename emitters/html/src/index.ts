...
<title>${esc(title)}</title><link rel="icon" href="${FAVICON}"><link rel="icon" media="(prefers-color-scheme: dark)" href="${FAVICON_DARK}"><style>${STYLE}</style></head>
<body>
${body}
</body>
</html>
